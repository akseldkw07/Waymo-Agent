...
from ..dataclasses import RequestStatus, VehicleStatusEnum
...
class RideShareObservationMixin(GraphMixinInterface):
    ...
    TODO re-implement based on networkx + osmnx
    """
    ...
    def _initialize_vehicles(self):
        ...
        Use ratio of nodes to self.config.vehicle_per_node to determine number of vehicles
        Place vehicles uniformly at random on the graph nodes
        Set self.num_vehicles
        """
