...
from waymo_agent.constants import DATA_IGNORE_DIR, WANDB_PROJECT_NAME, WANDB_TEAM_NAME
...
def start_wandb_run(
    ...
    wandb_dir = os.getenv("WANDB_OUTPUT_DIR") or DATA_IGNORE_DIR / "wandb_logs"
